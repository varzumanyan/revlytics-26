...
export const ExpenditureChartsGrid = ({ data }: ExpenditureChartsGridProps) => {
  ...
  const barChartData = useMemo(() => {
    ...
    return [{
      ...
      'Nov 23 YTD': Number(selectedItem.november2023Ytd) / 1000000,
      'Nov 24 YTD': Number(selectedItem.november2024Ytd) / 1000000,
      'Nov 25 YTD': selectedItem.november2025Ytd / 1000000,
    }];
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={400}>
              <BarChart data={barChartData} margin={{ top: 20, right: 30, left: 20, bottom: 60 }} barCategoryGap="30%" maxBarSize={60}>
                ...
                />
                <Bar dataKey="Nov 23 YTD" fill="hsl(var(--chart-primary))" />
                <Bar dataKey="Nov 24 YTD" fill="hsl(var(--chart-secondary))" />
                <Bar dataKey="Nov 25 YTD" fill="hsl(var(--chart-tertiary))" />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
