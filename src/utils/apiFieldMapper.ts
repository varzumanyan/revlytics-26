  ...
  static generateFieldMappings(data: any[]): FieldMapping[] {
    ...
    if (!dateInfo || !dateInfo.years || dateInfo.years.length < 3) {
      const mappings: FieldMapping[] = [
        ...
        { field: fieldSet.year1, label: 'December 2023', type: 'currency' as const },
        { field: fieldSet.year2, label: 'December 2024', type: 'currency' as const },
        { field: fieldSet.year3, label: 'December 2025', type: 'currency' as const },
        { field: fieldSet.changeField, label: 'Dec25 vs Dec24', type: 'currency' as const },
        { field: fieldSet.percentageField, label: 'YoY Change %', type: 'percentage' as const },
        { field: fieldSet.budgetPercentageField, label: 'Dec 25 YTD as % of FY26 Budget', type: 'percentage' as const },
    ...
    const mappings: FieldMapping[] = [
      { field: 'revenueType', label: 'Revenue Type', type: 'text' as const },
      { field: fieldSet.year1, label: `Dec ${dateInfo.years[0].slice(-2)} YTD`, type: 'currency' as const },
      { field: fieldSet.year2, label: `Dec ${dateInfo.years[1].slice(-2)} YTD`, type: 'currency' as const },
      { field: fieldSet.year3, label: `Dec ${dateInfo.years[2].slice(-2)} YTD`, type: 'currency' as const },
