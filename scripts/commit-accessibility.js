...
try {
  ...
  execSync(`git commit -m "feat: implement WCAG 2.1 Level AA accessibility compliance
...
- Add role attributes to all cards and data regions"`, { stdio: 'inherit' });
  
  console.log('Pushing to remote...');
  execSync('git push origin HEAD', { stdio: 'inherit' });
  
  console.log('✓ Accessibility changes committed and pushed successfully!');
} catch (error) {
